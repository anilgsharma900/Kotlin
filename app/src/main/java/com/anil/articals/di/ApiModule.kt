...
import com.anil.articals.BuildConfig
import com.anil.articals.MyApplication
...
class ApiModule {
    ...
    // u can use @provides or @inject fon injecting this method in Dagger generater class throgh @component
    @Provides
